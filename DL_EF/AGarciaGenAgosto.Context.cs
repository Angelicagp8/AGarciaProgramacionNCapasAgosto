...
namespace DL_EF
{
    ...
    public partial class AGarciaGenAgostoEntities : DbContext
    {
        public AGarciaGenAgostoEntities()
            : base("name=AGarciaGenAgostoEntities")
        {
        }
        ...
        public virtual int AlumnoAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string sexo, string email, Nullable<int> idSemestre)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AlumnoAdd", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, sexoParameter, emailParameter, idSemestreParameter);
        }
